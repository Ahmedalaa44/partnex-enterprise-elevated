    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-gradient-brand px-5 py-2.5 text-sm font-medium text-white transition-transform hover:scale-[1.02]"
          >
            Return home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Partnex | Build the Next" },
      {
        property: "og:description",
        content:
          "Secure, scalable and intelligent technology solutions. Partnex is the enterprise system integrator that helps organizations build the next.",
      },
